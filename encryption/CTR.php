...
{
function encrypt_ctr($plaintext, $key) {
$nonce = openssl_random_pseudo_bytes(8);
$ciphertext = openssl_encrypt($plaintext, 'des-ecb', $key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $nonce . "\x00\x00\x00\x00\x00\x00\x00\x01");
return $nonce . $ciphertext;
}
$key = 'secretkey';
$plaintext=$_POST["plaintext"];
$encrypted_data = encrypt_ctr($plaintext, $key);
